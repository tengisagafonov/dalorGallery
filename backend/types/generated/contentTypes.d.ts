...
export interface ApiAnalyticsEventAnalyticsEvent
  ...
  info: {
    description: 'Anonyme Nutzungsstatistik der Dalor Gallery';
    displayName: 'Statistikereignis';
  ...
  attributes: {
    ...
    eventType: Schema.Attribute.Enumeration<
      ['page_view', 'template_select', 'prompt_preview', 'prompt_copy']
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Gruppiert zusammengeh\u00F6rige Galerie-Vorlagen';
  ...
  attributes: {
    autoTranslate: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    children: Schema.Attribute.Relation<'oneToMany', 'api::category.category'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    descriptionDe: Schema.Attribute.Text;
    descriptionHi: Schema.Attribute.Text;
    descriptionPa: Schema.Attribute.Text;
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    nameDe: Schema.Attribute.String;
    nameHi: Schema.Attribute.String;
    namePa: Schema.Attribute.String;
    ...
    subcategoryTemplates: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTemplateTemplate extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Eine anpassbare Prompt-Vorlage f\u00FCr Dalor Gallery';
    displayName: 'Vorlage';
  ...
  attributes: {
    ...
    coverFit: Schema.Attribute.Enumeration<['cover', 'contain']> &
    ...
    inputFields: Schema.Attribute.Component<'template.input-field', true>;
    ...
    legacyId: Schema.Attribute.Integer & Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::template.template'
    ...
    publishedAt: Schema.Attribute.DateTime;
    searchKeywords: Schema.Attribute.JSON;
    ...
    titleDe: Schema.Attribute.String;
    titleHi: Schema.Attribute.String;
    titlePa: Schema.Attribute.String;
