...
const paths: Record<string, ReactNode> = {
  ...
  furniture: <><path d="M5 11V8a3 3 0 0 1 3-3h8a3 3 0 0 1 3 3v3" /><path d="M4 10a2 2 0 0 0-2 2v5h20v-5a2 2 0 0 0-4 0v2H6v-2a2 2 0 0 0-2-2ZM5 17v3M19 17v3" /></>,
  drinks: <><path d="M5 4h10l-1 16H6Z" /><path d="m10 4 4-2M16 8h3a3 3 0 0 1 0 6h-4" /></>,
  smartphone: <><rect x="6" y="2" width="12" height="20" rx="2" /><path d="M10 5h4M11 19h2" /></>,
  gem: <><path d="m3 9 4-5h10l4 5-9 12Z" /><path d="m3 9 9 4 9-4M7 4l5 9 5-9" /></>,
  interior: <><path d="M4 21V5h16v16M4 9h16" /><path d="M8 21v-7h8v7M9 6h.01M12 6h.01M15 6h.01" /></>,
  car: <><path d="m5 11 2-5h10l2 5" /><path d="M3 11h18v7H3Z" /><circle cx="7" cy="18" r="2" /><circle cx="17" cy="18" r="2" /><path d="M6 14h.01M18 14h.01" /></>,
